<br>
<div class="flex-shrink-0 p-3 bg-white rounded" style="width: 280px;">
    <a href="/" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
      <svg class="bi me-2" width="30" height="24"><use xlink:href="#bootstrap"></use></svg>
      <span class="fs-5 fw-semibold">GakhalSingh</span>
    </a>
    <ul class="list-unstyled ps-0">
      <li class="mb-1">
        ...
        <div class="collapse show" id="home-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><i class="bi bi-house-door"></i><a href="/home" class="link-dark rounded">Welkom</a></li>
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="orders-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><i class="bi bi-person-circle"></i><a href="#" class="link-dark rounded">Profile</a></li>
            <li><i class="bi bi-gear"></i><a href="#" class="link-dark rounded">Settings</a></li>
            <li><i class="bi bi-box-arrow-in-left"></i><a href="#" class="link-dark rounded">Sign Out</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="account-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><i class="bi bi-music-note-list"></i><a href="#" class="link-dark rounded">Music</a></li>
            <li><i class="bi bi-sliders"></i><a href="#" class="link-dark rounded">Style</a></li>
            <li><i class="bi bi-gear"></i><a href="#" class="link-dark rounded">Settings</a></li>
            <li><i class="bi bi-box-arrow-in-left"></i><a href="#" class="link-dark rounded">Sign out</a></li>
          </ul>
        </div>
